...
if (isset($_POST['submit']) && isset($_POST['status'])) {
    ...
    echo "<script>alert('Status updated successfully!'); window.location.href = 'appointment.php';</script>";
} else {
    echo "<script>alert('Status Not updated!'); window.location.href = 'appointment.php';</script>";
}
?>
