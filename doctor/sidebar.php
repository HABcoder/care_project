...
<body>
    ...
    <div class="sidebar d-none d-lg-block">
        <div class="sidebar-header text-center p-5">
            ...
            <h5 class="mb-1"><?php echo "Doctor"." ".substr($username,0,13)?>..</h5>
            <p class="text-muted small"><?php echo substr($email,0,22)  ?></p>
            <a href="logout_dt.php" class="btn btn-sm btn-outline-danger w-100 mt-2">Logout</a>
        </div>
        <ul class="nav flex-column mt-3">
            ...
            <li class="nav-item">
                <a class="nav-link" href="appointment.php">
                    <i class="fas fa-calendar-check"></i> My Appointment
                </a>
            </li>
            <li class="nav-item">
